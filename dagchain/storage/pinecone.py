...
def DagchainPineconeDefinitions(name, dagchains):
    assets = [asset for dagchain in dagchains for asset in dagchain.to_pinecone_assets()]
    ...
    return Definitions(
        assets=assets,
        resources={"pinecone": pinecone_index_name, "pinecone_io_manager": PineconeIOManager()},
        sensors=[
            build_asset_reconciliation_sensor(
                AssetSelection.all(),
